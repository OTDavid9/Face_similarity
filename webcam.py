...
def find_top_matches(live_embedding, df, top_k=5):
    """Compute cosine similarity and return top K BVNs."""
...
if __name__ == "__main__":
    ...
    df_faces = load_embeddings("output_with_faces_v4.csv")
    top_matches = find_top_matches(live_embedding, df_faces)

    print("\n🎯 Top 5 BVN Matches:")
    for idx, row in top_matches.iterrows():
        print(f"BVN: {row['BVN']} | Similarity: {row['Similarity']:.4f}")
